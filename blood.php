...
<!-- Second Grid -->
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container" id="blood-donation">
  <div class="w3-content">
    <div class="w3-third w3-center">
      <i class="fa fa-tint w3-padding-64 w3-text-red w3-margin-right"></i>
    </div>

    <div class="w3-twothird">
      <h1>Blood Donation</h1>
      <h5 class="w3-padding-32">After many successful campaign of blood donation last year and this year, now Serenity organization is starting another "Blood donation campaign 2016". We welcome you all be a part of this campaign either at individual level or in group. Please join this event & help us making Bangladesh red.</h5>
    </div>
  </div>
  
  <div class ="w3-row-padding w3-padding-60">
  <div class="w3-half">
  	<img src="img/b1.jpg"><i><br>Volunteers participating in Chevron blood donation program</i>
  </div>
  <div class="w3-half">
  	<img src="img/b2.jpg"><i><br>Voluntary Blood donation at Presidency University,Dhaka</i>
  </div>
  </div>
  <div class ="w3-row-padding w3-padding-16">
  <div class="w3-half">
  	<img src="img/b3.jpg"><i><br>Donating blood at  Sir Salimullah Medical College blood campaign</i>
  </div>
  <div class="w3-half">
  	<img src="img/b4.jpg" height="350px">
  </div>	
  </div>
...
$dsp  = mysqli_query($dbcon, "SELECT Name,Age,Gender,bloodGroup,Contact from volunteersforblood");
...
<br>
<h3><font color="red">Search For Blood</font></h3>
<form action="blood.php" method="POST" >
Blood Group: <input type="text" name="blood" />
<input type="submit" name="submit" value="SEARCH" style="font-size:12pt;color:green" />  <br><br>
</form>
<?php
if(isset($_POST['submit'])){
	$con = mysqli_connect("localhost","Amit","password" ,"Serenity");
	$sql = "select Name,Age,Gender,bloodGroup,Contact,Address from volunteersforblood
	where bloodGroup='$_POST[blood]'";
	...
	echo "</th>";
	echo "</tr>";
while ($result = mysqli_fetch_array($mydata, MYSQLI_ASSOC)) {
