...
<div class="w3-row-padding w3-padding-64 w3-container" id="cash-donation">
  <div class="w3-content">
    <div class="w3-twothird">
      <h1>Financial Support</h1>
      <h5 class="w3-padding-32">After many successful campaign of Financial Support last year and this year, now Serenity organization is starting another "Financial Support campaign 2014". We welcome you all be a part of this campaign either at individual level or in group. Please join this event & help us making Bangladesh prosperous.</h5>

    </div>

    <div class="w3-third w3-center">
      <i class="fa fa-money w3-padding-64 w3-text-grey"></i>
    </div>
  </div>
  <div class ="w3-row-padding w3-padding-16">
  <div class="w3-quarter">
  	<img src="img/f1.jpg"><br>Relief goods distribution among workers on disaster affected area,Chittagong
  </div>
  <div class="w3-quarter">
  	<img src="img/f2.jpg"><br>Sharing happiness at Ahsania Mission Orphanage,Dhaka
  </div>
  <div class="w3-quarter">
  	<img src="img/f3.jpg"><br>Volunteering work on Rajbari Orphanage, Sylhet
  </div>
  <div class="w3-quarter">
  	<img src="img/f4.jpg"><br>Volunteers helping out old aged people, Cox's Bazar
  </div>
...
$dsp  = mysqli_query($dbcon, "SELECT Name,Age,Gender,Contact from volunteers");
